...
expectation   (Libor fx st nd py cn mr)      (ForwardNonStandard rD e t2P f v)   = (hullAdjustmentFormula v f fx py) + mr
...
expectation   (Caplet fx st nd py cn mr k)   (BlackNonStandard rD e t2P v f vAd) = let fAd = hullAdjustmentFormula vAd f fx py 
                                                                                   in blackFormulaCall fAd (k - mr) e v
expectation   (Floorlet fx st nd py cn mr k) (BlackNonStandard rD e t2P v f vAd) = let fAd = hullAdjustmentFormula vAd f fx py 
...
calcGreeks   (Libor fx st nd py cn mr)      (ForwardNonStandard rD e t2P f v)   = [1.0]
