...
expectation   (Libor fx st nd py cn mr)      (ForwardNonStandard rD e f v)   = (hullAdjustmentFormula v f fx py) + mr
...
expectation   (Caplet fx st nd py cn mr k)   (BlackNonStandard rD e v f vAd) = let fAd = hullAdjustmentFormula vAd f fx py 
                                                                               in blackFormulaCall fAd (k - mr) e v
expectation   (Floorlet fx st nd py cn mr k) (BlackNonStandard rD e v f vAd) = let fAd = hullAdjustmentFormula vAd f fx py 
...
calcGreeks   (Libor fx st nd py cn mr)      (ForwardNonStandard rD e f v)   = [1.0]
...
calcGreeks   (Caplet fx st nd py cn mr k)   (BlackNonStandard rD e v f vAd) = [1.0, 1.0, 1.0]
calcGreeks   (Floorlet fx st nd py cn mr k) (BlackNonStandard rD e v f vAd) = [1.0, 1.0, 1.0]
